import * as userSelectors from '../selected_education';
          ...
          items: [
            {
              ...
              meta: {
                ...
                detail_url:
                  'http://diabetes-cuf.cms.promptly.health/api/v2/pages/156/',
                html_url:
                  'http://diabetes-cuf.cms.promptly.health/artigos/diabetes-ocular/',
              ...
              article_image_thumbnail: {
                url:
                  'https://cms.promptly.health/media/images/doenca-diabetes-ocular.2e16d0ba.fill-280x150.png',
                width: 280,
                height: 150,
              },
              article_image_150x150: {
                url:
                  'https://cms.promptly.health/media/images/doenca-diabetes-ocular.2e16d0ba.fill-150x150.png',
                width: 150,
                height: 150,
              },
              article_image_max_150x150: {
                url:
                  'https://cms.promptly.health/media/images/doenca-diabetes-ocular.max-150x150.png',
                width: 150,
                height: 84,
              },
              article_image_width_150x150: {
                url:
                  'https://cms.promptly.health/media/images/doenca-diabetes-ocular.width-150.png',
                width: 150,
                height: 84,
              },
              authors: [
      ...
      data: {
        ...
        meta: {
          ...
          parent: {
            ...
            meta: {
              ...
              detail_url:
                'http://diabetes-cuf.cms.promptly.health/api/v2/pages/153/',
              html_url: 'http://diabetes-cuf.cms.promptly.health/artigos/',
            },
            title: 'Artigos',
          },
        },
        ...
        header_image: {
          ...
          meta: {
            ...
            detail_url:
              'http://diabetes-cuf.cms.promptly.health/api/v2/images/163/',
            download_url:
              'https://cms.promptly.health/media/original_images/doenca-diabetes-ocular.png',
          },
          title: 'doenca-diabetes-ocular.png',
        },
        header_image_thumbnail: {
          url:
            'https://cms.promptly.health/media/images/doenca-diabetes-ocular.2e16d0ba.fill-950x250.png',
          width: 950,
          height: 250,
        },
        article_image_thumbnail: {
        ...
        search_image_thumbnail: {
          url:
            'https://cms.promptly.health/media/images/doenca-diabetes-ocular.2e16d0ba.fill-40x40.png',
          width: 40,
          height: 40,
        },
        article_image_150x150: {
...
describe('test user selectors', () => {
  test('getEducationPreviewArticles', () => {
    expect(userSelectors.getEducationPreviewArticles(state)).toEqual(
      state.education.previewArticles,
    );
  });
  test('getEducationArticle', () => {
    expect(userSelectors.getEducationArticle(state)).toEqual(
      state.education.article,
    );
  });
  test('getEducationArticles', () => {
    expect(userSelectors.getEducationArticles(state)).toEqual(
      state.education.articles,
    );
  });
  test('getSections', () => {
    expect(userSelectors.getSections(state)).toEqual(
      state.education.sections,
    );
  });
  test('getRecommendedArticles', () => {
    expect(userSelectors.getRecommendedArticles(state)).toEqual(
      state.education.recommended,
    );
  });
});
